...
function createServiceHandler(mode, tsConfig, ts, tsLocalized, documents, fileUpdatedCb, _onProjectFilesUpdate, workDoneProgress) {
    ...
    function getLanguageService() {
        if (!vueLs) {
            vueLs = vscode_vue_languageservice_1.createLanguageService({ typescript: ts }, languageServiceHost);
