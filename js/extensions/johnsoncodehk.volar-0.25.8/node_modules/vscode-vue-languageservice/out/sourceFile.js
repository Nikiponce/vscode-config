...
const jsons_raw_1 = require("./virtuals/jsons.raw");
...
function createSourceFile(initialDocument, tsLanguageService, ts, styleMode, documentContext, uriTsDocumentMap) {
    // sources
    ...
    // virtual scripts
    const _virtualStyles = styles_raw_1.useStylesRaw(ts, untrack(() => vueDoc.value), reactivity_1.computed(() => descriptor.styles), styleMode, documentContext);
    const virtualJsonBlocks = jsons_raw_1.useJsonsRaw(untrack(() => vueDoc.value), reactivity_1.computed(() => descriptor.customBlocks));
    ...
    return {
        uri: vueUri,
        getTemplateTagNames: untrack(() => { var _a; return (_a = virtualTemplateGen.templateCodeGens.value) === null || _a === void 0 ? void 0 : _a.tagNames; }),
        getTemplateAttrNames: untrack(() => { var _a; return (_a = virtualTemplateGen.templateCodeGens.value) === null || _a === void 0 ? void 0 : _a.attrNames; }),
    ...
    function updateTemplateScript() {
        var _a, _b, _c, _d;
        if (templateScriptData.projectVersion === ((_b = (_a = tsLanguageService.__internal__.host).getProjectVersion) === null || _b === void 0 ? void 0 : _b.call(_a))) {
            return false;
        }
        templateScriptData.projectVersion = (_d = (_c = tsLanguageService.__internal__.host).getProjectVersion) === null || _d === void 0 ? void 0 : _d.call(_c);
        ...
        let components = docText.indexOf(string_1.SearchTexts.Components) >= 0 ? tsLanguageService.doComplete(doc.uri, doc.positionAt(docText.indexOf(string_1.SearchTexts.Components))) : [];
    ...
    function shouldVerifyTsScript(tsUri, mode) {
        var _a, _b;
        if (tsUri.toLowerCase() === ((_a = virtualScriptGen.textDocumentForSuggestion.value) === null || _a === void 0 ? void 0 : _a.uri.toLowerCase())) {
            if (mode === 3) {
                return 'all';
            }
            if (mode === 1) {
        ...
        if (tsUri.toLowerCase() === ((_b = virtualScriptGen.textDocument.value) === null || _b === void 0 ? void 0 : _b.uri.toLowerCase())) {
            if (mode === 3) {
    ...
    function useDiagnostics() {
        ...
        const nonTs = [
            ...
            [useJsonsValidation(reactivity_1.computed(() => virtualJsonBlocks.textDocuments.value)), 0, []],
        ...
        return async (response, isCancel) => {
            var _a, _b;
            tsProjectVersion.value = (_b = (_a = tsLanguageService.__internal__.host).getProjectVersion) === null || _b === void 0 ? void 0 : _b.call(_a);
            // sort by cost
