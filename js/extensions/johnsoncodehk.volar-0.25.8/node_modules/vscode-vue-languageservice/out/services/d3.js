...
function register({ ts, sourceFiles, tsLanguageService }) {
    ...
    return async (document) => {
            ...
            for (const sourceMap of sourceFile.getTsSourceMaps()) {
                ...
                function nodeWalker(node) {
                    if (ts.isVariableDeclaration(node)
                        ...
                        const range = sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(node.name.getStart(scriptAst)), sourceMap.mappedDocument.positionAt(node.name.getStart(scriptAst) + node.name.getWidth(scriptAst)));
                        const _argRange = getArgRanges(node.initializer, scriptAst);
                        const argsStartRange = _argRange ? sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(_argRange.start), sourceMap.mappedDocument.positionAt(_argRange.start)) : undefined;
                        const argsEndRange = _argRange ? sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(_argRange.end), sourceMap.mappedDocument.positionAt(_argRange.end)) : undefined;
                        ...
                        && node.body) {
                        const range = sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(node.name.getStart(scriptAst)), sourceMap.mappedDocument.positionAt(node.name.getStart(scriptAst) + node.name.getWidth(scriptAst)));
                        const blockStartRange = sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(node.body.getStart(scriptAst)), sourceMap.mappedDocument.positionAt(node.body.getStart(scriptAst)));
                        const blockEndRange = sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(node.body.getStart(scriptAst) + node.body.getWidth(scriptAst)), sourceMap.mappedDocument.positionAt(node.body.getStart(scriptAst) + node.body.getWidth(scriptAst)));
                        ...
                        const nameRange = sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(node.name.getStart(scriptAst)), sourceMap.mappedDocument.positionAt(node.name.getStart(scriptAst) + node.name.getWidth(scriptAst)));
                        const startRange = sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(node.initializer.getStart(scriptAst)), sourceMap.mappedDocument.positionAt(node.initializer.getStart(scriptAst)));
                        const endRange = sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(node.initializer.getStart(scriptAst) + node.initializer.getWidth(scriptAst)), sourceMap.mappedDocument.positionAt(node.initializer.getStart(scriptAst) + node.initializer.getWidth(scriptAst)));
                        const blockStartRange = sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(node.initializer.body.getStart(scriptAst)), sourceMap.mappedDocument.positionAt(node.initializer.body.getStart(scriptAst)));
                        const blockEndRange = sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(node.initializer.body.getStart(scriptAst) + node.initializer.body.getWidth(scriptAst)), sourceMap.mappedDocument.positionAt(node.initializer.body.getStart(scriptAst) + node.initializer.body.getWidth(scriptAst)));
                        ...
                        if (name) {
                            const range = sourceMap.getSourceRange(sourceMap.mappedDocument.positionAt(name.getStart(scriptAst)), sourceMap.mappedDocument.positionAt(name.getStart(scriptAst) + name.getWidth(scriptAst)));
        ...
        for (const funcCall of funcCalls) {
            for (const definition of funcCall.definitions) {
                const uri = node_1.Location.is(definition) ? definition.uri : definition.targetUri;
                const range = node_1.Location.is(definition) ? definition.range : definition.targetSelectionRange;
                if (uri === document.uri) {
