...
exports.getGlobalDoc = void 0;
const vscode_languageserver_textdocument_1 = require("vscode-languageserver-textdocument");
const shared_1 = require("@volar/shared");
const upath_1 = require("upath");
function getGlobalDoc(root) {
    let code = `
...
`;
    return vscode_languageserver_textdocument_1.TextDocument.create(shared_1.fsPathToUri(upath_1.join(root, '__VLS_globals.ts')), 'typescript', 0, code);
}
exports.getGlobalDoc = getGlobalDoc;
